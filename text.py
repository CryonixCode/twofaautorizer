translations = {
    "ru": {
        ...
        "menu.change_2fa_updated": "Настройка изменения 2FA обновлена: {value}",
        ...
        "log.api_data_missing": "Недостаточно данных в {file}: api_id или api_hash отсутствуют",
    ...
    "en": {
        ...
        "menu.change_2fa_updated": "Change 2FA setting updated: {value}",
